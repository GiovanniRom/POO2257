...
public class AltaEmpleado extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTabbedPane1.setBorder(javax.swing.BorderFactory.createTitledBorder(null));
        ...
        layout.setVerticalGroup(
            ...
            .add(layout.createSequentialGroup()
                .addContainerGap()
                .add(jTabbedPane1, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 451, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
    ...
    private void jButton5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton5MouseClicked
        ...
        this.limpiarFormulario();
         ...
         emp.setNombre(this.jTextField5.getText());
         emp.setApPaterno(this.jTextField7.getText());
         emp.setApMaterno(jTextField8.getText());
         emp.setEdad(Integer.parseInt(jTextField9.getText()));
         emp.setCurp(jTextField1.getText());
         emp.setDomicilio(new Direccion());
         emp.getDomicilio().setCalle(this.jTextField10.getText());
         emp.getDomicilio().setNumero(this.jTextField15.getText());
         emp.getDomicilio().setColonia(this.jTextField11.getText());
         emp.getDomicilio().setDelegacion(this.jTextField12.getText());
         emp.getDomicilio().setEstado(this.jTextField13.getText());
         emp.setNumeroEmpleado(Integer.parseInt(this.jTextField2.getText()));
         emp.setDepartamento(this.jTextField3.getText());
         emp.setSueldo(Float.parseFloat(this.jTextField4.getText()));
         emp.setHorasExtra(Integer.parseInt(this.jTextField6.getText()));
